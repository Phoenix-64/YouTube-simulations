...
### 28 February 23 - An endothermic chemical reaction ###
...
### 27 February 23 - Coherence of waves with random sources ###
...
#define LOG_SCALE 0.3     /* scaling factor for energy log representation */
...
### 26 February 23 - Von Kármán vortices behind an accelerating airplane wing ###
...
#define SMOOTH_FACTOR 0.14       /* factor by which to smoothen */
...
### 25 February 23 - Histogram of particle distribution in a maze ###
...
#define NXMAZE 56      /* width of maze */
#define NYMAZE 56      /* height of maze */
...
### 24 February 23 - An exothermic chemical reaction ###
...
#define RD_TYPES 3              /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 2       /* initial condition of particles */
#define REACION_DIST 3.1        /* maximal distance for reaction to occur */
#define REACTION_PROB 0.5      /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.005  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 1            /* set to 1 to make reaction exo/endothermic */
...
### 23 February 23 - Waves in a medium with periodic index of refraction ###
...
### 22 February 23 - Von Kármán vortices behind an airplane wing, at smaller speed ###
...
#define VSCALE_SPEED 1.5      /* additional scaling factor for color scheme Z_EULER_SPEED */
#define VMEAN_SPEED 0.0       /* mean value around which to scale for color scheme Z_EULER_SPEED */
#define VSCALE_DENSITY 100.0      /* additional scaling factor for color scheme Z_EULER_DENSITY */
#define VSCALE_VORTICITY 10.0     /* additional scaling factor for color scheme Z_EULERC_VORTICITY */
#define VORTICITY_SHIFT 0.3     /* vertical shift of vorticity */
...
### 21 February 23 - A heterogeneous chemical reaction ###
...
### 20 February 23 - Particles escaping from a large honeycomb maze ###
...
#define NSTEPS 14900     /* number of frames of movie */
#define TIME 1500        /* time between movie frames, for fluidity of real-time simulation */ 
#define DPHI 0.00002     /* integration step */
#define NVID 25          /* number of iterations between images displayed on screen */
#define END_FRAMES 100    /* number of still frames at the end of the movie */
...
#define NCOLORS 1000     /* number of colors */
#define COLORSHIFT 0     /* hue of initial color */ 
#define COLOR_HUEMIN 90   /* minimal color hue */
#define COLOR_HUEMAX 340 /* maximal color hue */
#define RAINBOW_COLOR 0  /* set to 1 to use different colors for all particles */
#define FLOWER_COLOR 0   /* set to 1 to adapt initial colors to flower billiard (tracks vs core) */
#define NSEG 100         /* number of segments of boundary */
#define LENGTH 0.025       /* length of velocity vectors */
...
#define NXMAZE 48      /* width of maze */
#define NYMAZE 40      /* height of maze */
#define MAZE_MAX_NGBH 6     /* max number of neighbours of maze cell */
#define RAND_SHIFT 11    /* seed of random number generator */
#define MAZE_XSHIFT 0.0     /* horizontal shift of maze */
#define MAZE_RANDOM_FACTOR 0.1     /* randomization factor for S_MAZE_RANDOM */
...
### 19 February 23 - A phased array seen from a larger distance ###
...
```
    ...
    for (k=-4; k<5; k++)
    {
        x1 = 0.025*(double)source_counter + 0.1*(double)k;
...
#define DRAW_COLOR_SCHEME 1    /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.5     /* scale of color scheme bar */
#define COLORBAR_RANGE_B 0.07   /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
...
### 18 February 23 - Von Kármán vortices behind an airplane wing ###
...
### 17 February 23 - Step polymerization ###
...
#define INITXMIN -1.05
#define INITXMAX 1.05	/* x interval for initial condition */
...
#define REACTION_DIFFUSION 1    /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 9           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 9              /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 0       /* initial condition of particles */
#define REACION_DIST 2.6        /* maximal distance for reaction to occur */
#define REACTION_PROB 0.5       /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.005  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define COLLISION_TIME 25       /* time during which collisions are shown */
...
### 16 February 23 - Dance of the bees: Heat map representation of a billiard in a honeycomb maze with rounded coners ###

**Program:** `particle_billiard.c` 

**Initial condition in function `animation()`:** `init_drop_config(-0.05, 0.05, 0.0, 0.3*PID, configs);`
...
### 15 February 23 - Polymerization with dissociation ###
...
### 14 February 23 - Waves in a medium with random index of refraction ###
...
### 13 February 23 - Von Kármán vortices behind an airfoil ###
...
#define ADD_FORCE_FIELD 1   /* set to 1 to add a foce field (for compressible Euler equation) */
#define POTENTIAL 7         /* type of potential or vector potential, see list in global_3d.c  */
#define FORCE_FIELD 3       /* type of force field, see list in global_3d.c  */

#define ANTISYMMETRIZE_WAVE_FCT 0   /* set tot 1 to make wave function antisymmetric */
#define ADAPT_STATE_TO_BC 1     /* set to 1 to smoothly adapt initial state to obstacles */
#define OBSTACLE_GEOMETRY 198   /* geometry of obstacles, as in B_DOMAIN */
#define BC_STIFFNESS 50.0       /* controls region of boundary condition control */
...
#define LAMBDA 0.6	    /* parameter controlling the dimensions of domain */
#define MU 0.12	            /* parameter controlling the dimensions of domain */
#define NPOLY 5             /* number of sides of polygon */
#define APOLY 2.0          /* angle by which to turn polygon, in units of Pi/2 */
#define MDEPTH 7            /* depth of computation of Menger gasket */
#define MRATIO 5            /* ratio defining Menger gasket */
...
### 12 February 23 - Heat map representation of a billiard in a honeycomb maze ###
...
#define NXMAZE 20      /* width of maze */
...
### 11 February 23 - An example of chain growth polymerization ###
...
#define REACTION_DIFFUSION 1    /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 7           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 7              /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 2      /* initial condition of particles */
#define REACION_DIST 3.5       /* maximal distance for reaction to occur */
#define REACTION_PROB 0.5      /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.001  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define COLLISION_TIME 25       /* time during which collisions are shown */
...
### 10 February 23 - Energy flux of waves leaving the Mandelbrot set ###
...
### 9 February 23 - Von Kármán vortices behind an elliptical obstacle ###
...
#define ADD_FORCE_FIELD 1   /* set to 1 to add a foce field (for compressible Euler equation) */
#define POTENTIAL 7         /* type of potential or vector potential, see list in global_3d.c  */
#define FORCE_FIELD 2       /* type of force field, see list in global_3d.c  */

#define ANTISYMMETRIZE_WAVE_FCT 0   /* set tot 1 to make wave function antisymmetric */
#define ADAPT_STATE_TO_BC 1     /* set to 1 to smoothly adapt initial state to obstacles */
#define OBSTACLE_GEOMETRY 199   /* geometry of obstacles, as in B_DOMAIN */
#define BC_STIFFNESS 50.0       /* controls region of boundary condition control */
...
### 8 February 23 - A rotating laser beam in a honeycomb maze ###
...
### 7 February 23 - The reversible chemical reaction A + A ⇌ B ###
...
#define RD_INITIAL_COND 0      /* initial condition of particles */
#define REACION_DIST 2.45       /* maximal distance for reaction to occur */
#define REACTION_PROB 0.5      /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.001  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define COLLISION_TIME 25       /* time during which collisions are shown */
...
### 6 February 23 - Beam formation in a phased array ###
...
```
    ...
    for (k=-4; k<5; k++)
    {
        x1 = 0.075*(double)source_counter + 0.3*(double)k;
        if ((x1 > 0.25*XMIN)&&(x1 < 0.25*XMAX)) 
        {
            add_circular_wave(sign1, x1, y, phi, psi, xy_in);
            printf("Adding wave at (%.2lg, %.2lg)\n", x1, y);
        }
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 10    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 0  /* set to 1 to alternate sign of oscillating source */
...
#define DRAW_COLOR_SCHEME 1    /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.5     /* scale of color scheme bar */
#define COLORBAR_RANGE_B 0.15   /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
...
### 5 February 23 - 3D rendering of vorticity and speed of von Kármán vortices ###
...
### 4 February 23 - Solving a honeycomb maze using laser beams ###

**Program:** `particle_billiard.c` 

**Initial condition in function `animation()`:** `init_drop_config(-1.2, 0.05, 0.0, 0.3*PID, configs);`
...
### 3 February 23 - The chemical dissociation reaction B → A + A ###
...
#define REACTION_DIFFUSION 1    /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 5           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 2              /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 20      /* initial condition of particles */
...
#define PRINT_PARTICLE_NUMBER 0     /* set to 1 to print total number of particles */
#define PLOT_PARTICLE_NUMBER 1      /* set to 1 to make of plot of particle number over time */
#define PARTICLE_NB_PLOT_FACTOR 1.75 /* expected final number of particles over initial number */
#define PRINT_LEFT 0        /* set to 1 to print certain parameters at the top left instead of right */
#define PLOT_SPEEDS 0       /* set to 1 to add a plot of obstacle speeds (e.g. for rockets) */
#define PLOT_TRAJECTORIES 0     /* set to 1 to add a plot of obstacle trajectories (e.g. for rockets) */
#define VMAX_PLOT_SPEEDS 0.6    /* vertical scale of plot of obstacle speeds */
...
### 2 February 23 - Energy flux in a phased array ###
...
### 1 February 23 - Vorticity and speed of von Kármán vortices ###
